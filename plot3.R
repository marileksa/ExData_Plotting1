...
# 4. writes this scatterplot to png file: plot3.png
###############################################################################
...
#create the requested scatterplot and write it out to png file
png(file="plot3.png", width=480, height=480, bg = "transparent")
with(a, plot(DateTime, Sub_metering_1, xlab = "", ylab = "Energy sub metering", type = "n"))
